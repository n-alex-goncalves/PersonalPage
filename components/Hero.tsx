...
const Hero = () => {
  return (
    <div className="hero min-h-screen min-w-full flex flex-col items-center justify-center">
      <div className="hero-content text-center m-4">
        <div className="max-w-md">
          ...
          <p className="text-3xl py-6 w-full">
            a Software Engineer, book hobbyist, occasional community volunteer near London, England.
          </p>
      ...
      <div className="absolute bottom-10 flex justify-center animate-bounce">
