        ...
        <HoverUnderline variant={"bg-slate-50"} groupName={"page"}>
            <Link href={link} target="_blank">
                <svg 
                    ...
                    height={height} 
                    fill="currentColor" 
                    className="bi bi-arrow-up-right-square relative top-[3px] fill-neutral-content hover:fill-slate-50 transition duration-300 ease-in-out"
                    viewBox="0 0 16 16"
                >
                    <path 
                        fillRule="evenodd" 
        ...
        <HoverUnderline variant={"bg-slate-50"} groupName={"github"}>
            <Link href={link} target="_blank">
                <svg 
                    ...
                    height={height}
                    fill="currentColor" 
                    className="bi bi-github relative top-[3px] fill-neutral-content hover:fill-slate-50 transition duration-300 ease-in-out"
                    viewBox="0 0 16 16"
                >
